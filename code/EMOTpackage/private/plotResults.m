...
text(pars.b(1)-0.1,pars.d(2)+0.05,'Prosocial','Color','black','FontSize',14,'FontName','Arial')
text(-pars.b(1),pars.d(2)+0.05,'Selfish','Color','black','FontSize',14,'FontName','Arial')
...
text(mean(radians_lbls2(:,1)),-0.028,'S','Color','black','FontSize',14,'FontName','Arial')
text(mean(radians_lbls2(:,2)),-0.028,'P','Color','black','FontSize',14,'FontName','Arial')
